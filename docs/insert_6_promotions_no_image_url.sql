-- ============================================================
-- MySQL: 6 khuyến mãi mẫu - BẢNG CHƯA CÓ CỘT image_url
-- Dùng file này nếu chạy insert_6_promotions_sample.sql báo lỗi thiếu cột image_url
-- ============================================================
...
('MOMO58', 'BETA VÉ RẺ MOMO MUA LIỀN!',
  ...
  'FIXED_AMOUNT', NULL, 42000, 100000, NULL,
...
('OFF20', '20% OFF',
  ...
  'PERCENTAGE', 20.00, NULL, 150000, 50000,
...
('COMBO2VE', 'Mua 2 vé tặng 1 Bắp',
  ...
  'BUY_X_GET_Y', NULL, NULL, 120000, NULL,
...
('MEMBER50K', 'Thành viên giảm 50.000₫',
  ...
  'FIXED_AMOUNT', NULL, 50000, 200000, 50000,
...
('DOUBLEPOINT', 'Nhân đôi điểm thưởng',
  ...
  'POINTS_MULTIPLIER', NULL, NULL, 0, NULL,
